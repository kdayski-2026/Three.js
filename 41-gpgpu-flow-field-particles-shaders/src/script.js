...
gui.add(gpgpu.particlesVariable.material.uniforms.uFlowFieldInfluence, 'value', 0, 1, 0.001).name('uFlowFieldInfluence')
gui.add(gpgpu.particlesVariable.material.uniforms.uFlowFieldStrength, 'value', 0, 10, 0.001).name('uFlowFieldStrength')
