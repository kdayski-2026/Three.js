...
export default function Table() {
  ...
  const textures = useTexture(
    {
      map: '/table/min/wood_table_001_diff_1k.jpg',
      normalMap: '/table/min/wood_table_001_nor_gl_1k.jpg',
      aoMap: '/table/min/wood_table_001_arm_1k.jpg',
      roughnessMap: '/table/min/wood_table_001_rough_1k.jpg',
    },
    () => {
