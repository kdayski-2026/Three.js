...
export default function Environment() {
  ...
  const wallTextures = useTexture(
    {
      map: '/environment/min/beige_wall_001_diff_1k.jpg',
      normalMap: '/environment/min/beige_wall_001_nor_gl_1k.jpg',
      aoMap: '/environment/min/beige_wall_001_arm_1k.jpg',
      roughnessMap: '/environment/min/beige_wall_001_rough_1k.jpg',
    },
    () => {
  ...
  const floorTextures = useTexture(
    {
      map: '/environment/min/laminate_floor_02_diff_1k.jpg',
      normalMap: '/environment/min/laminate_floor_02_nor_gl_1k.jpg',
      aoMap: '/environment/min/laminate_floor_02_arm_1k.jpg',
      roughnessMap: '/environment/min/laminate_floor_02_rough_1k.jpg',
    },
    () => {
